...
class AssetManager:
    def __init__(self):
        ...
        if 'transactions' not in st.session_state:
            ...
            tx_data = {
                'Date': ['2025-11-25', '2025-11-27', '2025-12-10', '2025-12-25', '2026-01-27'],
                'Type': ['収入', '支出', '支出', '収入', '支出'],
                'Category': ['給与', '三井住友カード', 'JCBカード', '給与(賞与含)', '三井住友カード'],
                'Amount': [350000, 120000, 45000, 800000, 150000],
                'Status': ['完了', '完了', '予定', '予定', '予定'] # 予定か完了か
            }
